...
from network_with_reversal import ExtendedNeuronalNetworkWithReversal
from simulation_utils import run_unified_simulation, check_criticality_during_run
from activity_vis_utils import visualize_activity_grid, plot_network_activity_with_stimuli, plot_psth_and_raster
from network_vis_utils import plot_network_connections_sparse, visualize_distance_weights
from neuron_vis_utils import plot_reversal_effects
from criticality_analysis_utils import plot_enhanced_criticality_analysis,analyze_criticality_comprehensively
from correlation_length_utils import visualize_spatial_correlations
...
# Call the standalone visualization function
   ...
   # Add spatial correlation visualization
    ...
    spatial_correlation_results = visualize_spatial_correlations(
        ...
        time_bin_ms=30,  # Larger time bins to capture correlations better
        dt=dt,
...
def run_biologically_plausible_simulation(random_seed=42):
    ...
    return run_improved_experiment(
        ...
        duration=10_000,                # 600 ms to observe many avalanches
