...
def run_6_layer_experiment(
    ...
    visualize_activity_layout_grid(
...
if __name__ == "__main__":
    ...
    neuron_config = {
        ...
        'tau_m': 10.0, 'tau_ref': 2.5, 'tau_e': 3.0, 'tau_i': 7.0,
        'e_reversal': 0.0, 'i_reversal': -80.0,
        'v_noise_amp': 0.08, 'i_noise_amp': 0.0088, # Low noise
    ...
    # --- MODIFIED: Base Delay ---
    base_delay = 1.5 # ms (average delay for distance calculation)
