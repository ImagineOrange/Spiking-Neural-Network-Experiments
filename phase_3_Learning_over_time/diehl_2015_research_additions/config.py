...
4:1 Excitatory:Inhibitory Ratio (Biological Plausibility Experiment)

This module contains all configurable parameters for the spiking neural network
MNIST classification experiment. This version implements a 4:1 E:I ratio as
suggested in the Diehl & Cook (2015) paper for increased biological plausibility.
"""
...
class Config:
    """Configuration class for spiking MNIST experiment with 4:1 E:I ratio"""

    def __init__(self):
        # ======================================================================
        # Mode Settings
        # ======================================================================
        self.test_mode = False  # True: test with pretrained weights, False: train from scratch
        ...
        # ======================================================================
        # Network Architecture - MODIFIED FOR 4:1 E:I RATIO
        # ======================================================================
        self.n_input = 784  # Number of input neurons (28x28 MNIST images)
        self.n_e = 400  # Number of excitatory neurons
        self.n_i = 100  # Number of inhibitory neurons (4:1 ratio with excitatory)
        ...
        # ======================================================================
        # Membrane Noise Parameters
        # ======================================================================
        self.noise_sigma_e = 0.3 * mV  # Noise amplitude for excitatory neurons
        self.noise_sigma_i = 0.3 * mV  # Noise amplitude for inhibitory neurons
        ...
        self.input_conn_names = ['ee_input', 'ei_input']  # CRITICAL: Must include ei_input for Input→Inhibitory
    ...
    def _compute_derived_params(self):
        ...
        if self.test_mode:
            ...
            # Default: 5 epochs over the training set
    ...
    def get_neuron_eqs_e(self):
        """Get excitatory neuron equations with membrane noise"""
        eqs = '''
    ...
    def get_neuron_eqs_i(self):
        """Get inhibitory neuron equations with membrane noise"""
        return '''
  ...
  Network: {self.n_input} input -> {self.n_e} excitatory, {self.n_i} inhibitory (4:1 E:I ratio)
  Dataset: {classes_str}
